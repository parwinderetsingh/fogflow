...
docker run -d --name=rabbitmq -p 5672:5672 -e RABBITMQ_DEFAULT_USER='admin'  -e RABBITMQ_DEFAULT_PASS='mypass' arm64v8/rabbitmq
...
docker run -d --name=designer -v $(pwd)/config.json:/config.json -p 1030:1030 -p 80:80  fogflow/designer:$htype
